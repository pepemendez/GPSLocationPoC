package com.example.albo_poc_gps.services
...
import com.example.albo_poc_gps.MainActivity
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(p0: RemoteMessage) {
        ...
        */
        ...
        val uuid = UserPreferences().getUUID(applicationContext)

        if(uuid != p0?.data?.get("uuid")) {
